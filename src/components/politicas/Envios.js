    ...
    return (
      <div id="politicas">
        <section>
          ...
          <p>Gracias a una gran compañía como Correos Express, se garantiza la entrega en un plazo máximo de 48h, siempre que las circunstancias lo permitan.</p>
          <p>Llámanos para más información al (+34) 913 436 516</p>
          <p id="SemiBold">Gastos de Envío a PENÍNSULA</p>
          <p>
            Los gasto de envío variarán dependiendo del volumen de cada producto. Al final de la compra podrá comprobar los gastos que conlleva cada envío, variando desde los 2,95 para un sobre, 4,95€
            para un paquete de hasta 5kg y hasta un máximo de 10,00€ por pesos superiores. Impuestos no incluidos.
          </p>
          <p>Sobre 2,95€ + iva</p>
          ...
          <p>
            Para cualquier consulta relacionaza para envíos a otras comunidades o provincias fuera de la península u otros países, rogamos se ponga en contacto en el télefono (+34) 913 436 516 o en el
            correo pedidos@procorlab.es
          </p>
          <p id="SemiBold">CANCELACIÓN DE PEDIDOS</p>
          <p>Procor, (de aquí en adelante, LA EMPRESA) aceptará cancelaciones de pedidos cuando se soliciten antes del envío del mismo.</p>
